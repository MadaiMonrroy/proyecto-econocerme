<template>
    <div class="flex justify-center items-center min-h-screen -m-8">
      <div
        class="relative w-[900px] h-[650px] bg-white shadow-2xl border border-blue-300 rounded-lg overflow-hidden p-10"
      >
        ...
        <div class="text-center mb-8">
          <img src="@/assets/logoec.svg" alt="Logo" class="mx-auto w-48 h-32" />
  ...
  export default {
    ...
    mounted() {
      ...
      const idCurso = route.query.idCurso;
    ...
    methods: {
      ...
      goBack() {
        ...
        this.$router.push({ name: 'nombreRutaCertificaciones' }); // Cambia 'nombreRutaCertificaciones' por la ruta correcta
      },
      printCertificate() {
        // Aquí puedes agregar la lógica para imprimir el certificado
        window.print();
      },
    },
  };
