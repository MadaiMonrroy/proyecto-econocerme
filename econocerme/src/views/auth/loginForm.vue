<template>
  <div
    class="flex w-full min-h-screen bg-gradient-custom items-center justify-center"
  >
    <div
      class="w-full max-w-md bg-white bg-opacity-35 rounded-3xl shadow-2xl overflow-hidden p-8"
    >
      <!-- Formulario de login -->
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="mb-2">
          <label
            for="email"
            class="block text-gray-950 text-sm font-medium mb-2"
            >Email:</label
          >
          <div class="relative">
            <div
              class="flex items-center border border-gray-200 rounded-lg shadow-sm bg-gray-800 bg-opacity-0"
            >
              <img
                src="@/assets/icon.correo.png"
                alt="Email Icon"
                class="absolute left-3 h-6 w-6 text-gray-500"
              />
              <input
                type="email"
                v-model="email"
        ...
        <div class="mb-2">
          ...
          <div class="relative">
            <div
              class="flex items-center border border-gray-200 rounded-lg shadow-sm bg-gray-100 bg-opacity-0"
            >
              <img
                src="@/assets/icon.password.png"
                alt="Password Icon"
                class="absolute left-3 h-6 w-6 text-gray-600"
              />
              <input
        ...
        <div class="flex items-center mb-6 ml-1">
          ...
          />
          <label for="remember" class="ml-2 text-gray-950 text-sm"
        ...
        <div class="flex justify-center items-center mt-6">
          <p class="text-center text-gray-950 text-sm">
            ...
            <Button
              label="Regístrate"
              link
              class="p-button-text !text-violet-800 hover:text-purple-100 underline"
              @click="goToRegister"
            ></Button>
          </p>
        </div>
...
<style scoped>
.loader {
  border: 4px solid rgba(0, 0, 0, 0.1); /* Puedes ajustar el grosor del borde si lo deseas */
  border-radius: 50%;
  border-top: 4px solid #7b1fa2; /* Color del borde superior */
  width: 48px; /* Ajusta el tamaño aquí */
  height: 48px; /* Ajusta el tamaño aquí */
  animation: spin 1s linear infinite; /* Puedes ajustar la velocidad de la animación aquí */
}
