    ...
    >
      ...
      >
        ...
        <div class="mb-2">
          ...
          <div class="relative">
            <InputGroup>
              <InputGroupAddon class="!bg-purple-200">
                <i class="pi pi-at" />
              </InputGroupAddon>
              <InputText
                type="email"
                ...
                class="w-full pl-12 py-2 !bg-purple-200 bg-opacity-50 border-none rounded-lg placeholder-gray-500 focus:outline-none focus:ring-2 !focus:ring-purple-950"
                autofocus
                fluid
              />
            </InputGroup>
          ...
          <div class="relative">
            <InputGroup>
              ...
              <InputText
                ...
                id="password"
                placeholder="******"
                class="w-full pl-12 py-2 !bg-purple-200 placeholder-gray-500 bg-opacity-50 border-none rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-950"
                fluid
              />
              <InputGroupAddon class="!bg-purple-200">
                <i
