...
import  {listaCursos,cursosLibresporUsuario, obtenerCurso, editarCurso, eliminarCurso, agregarCurso, listaCursosCoach }  from '../controllers/cursos.controllers.js';
...
router.get('/cursoCoach/:idUsuario', listaCursosCoach)
