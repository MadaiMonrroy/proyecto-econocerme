...
import {listaModulos, obtenerModulo, agregarModulo, editarModulo, eliminarModulo,listaModulosHabilitados } from '../controllers/modulos.controllers.js';
...
router.get('/listaModulosHabilitados/:idCurso', listaModulosHabilitados)
